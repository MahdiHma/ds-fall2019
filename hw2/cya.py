...
username = str(input(
    'Enter Your Instagram Username here!!! Please enter correctly.\n >>>'))  # gets your Instagram username here in string format
    ...
    for participants in data:
        ...
        if (len(p) == 2):
            if (p[0] == username):
                ...
                print(
                    'The instagram username you entered is wrong. Try again or maybe change the username argument in source code.')
                sys.exit()
            createDir(username)
